  ...
  return (
    <div>
      ...
      <div className="ContainerConnectImg">
        <h1 className="Homess">Search properties for sale</h1>
        <img
          className="Imagessajd"
          src="https://argonaut.au.reastatic.net/resi-property/prod/homepage-web/web_lrg-59e123c20c1b8a953941.webp"
        ></img>
      </div>
      <div className="mt-12 pt-4 gap-x-6 gap-y-8 grid grid-cols-2 md:grid-cols-5 lg-grid-cols-4 p-3">
        {sellCard.length > 0 &&
          sellCard.map((prop, index) => (
            <div
              key={index}
